...
function App() {
  ...
  return (
    <>
      <div className="bg-black w-dvw h-dvh relative text-gray-200 shadow-2xl flex flex-col shadow-orange-50 items-center justify-center">
        <form 
        onSubmit={submitHandler}
        className={` bg-gray-900/50 backdrop-blur-2xl min-w-100 p-3 gap-5 min-h-50 border flex flex-col rounded-lg -translate-y-1/2`}
        >
        ...
        <div className="border p-5 text-2xl rounded-lg ring-3 ring-blue-400/60">
          {
